...
//	borrowers = library.AddBorrower(borrowers, &borrower.Borrower{Name: "Sue", MaxBooks: 3})
//	books = library.AddBook(books, &book.Book{Title: "War And Peace", Author: "Tolstoy"})
//	books = library.AddBook(books, &book.Book{Title: "Great Expectations", Author: "Dickens"})
